...
import { OrganizacionService } from '../organizacion/organizacion.service'; // ← Cambiado a OrganizationsService
import {
  LoginRequestBody,
  RegisterUsuarioDto,
  RegisterEmpresaDto,
...
import { Organizacion } from '../../Entities/organizacion.entity'; // ← Cambiado a organizations.entity
...
export class AuthService {
  ...
  constructor(
    ...
    private readonly organizationsService: OrganizacionService, // ← Cambiado
