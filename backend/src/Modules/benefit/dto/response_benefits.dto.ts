...
export class BenefitsResponseDTO {
  ...
  @ApiProperty({ example: '2025-12-15T10:30:45Z', description: 'Fecha de registro' })
  fecha_registro: Date;

  @ApiProperty({ example: '2025-12-15T10:30:45Z', description: 'Fecha de última modificación' })
  ultimo_cambio: Date;
