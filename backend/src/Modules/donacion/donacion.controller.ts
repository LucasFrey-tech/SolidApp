...
import { JwtAuthGuard } from '../PRUEBA REFACTOR/jwt-auth.guard';
import {
  ApiTags,
  ApiOperation,
  ApiResponse,
...
import { CurrentUser } from '../PRUEBA REFACTOR/current-user.decorator';
import type { JwtPayload } from '../PRUEBA REFACTOR/jwt-payload.interface';
@ApiTags('Donaciones')
@ApiBearerAuth()
